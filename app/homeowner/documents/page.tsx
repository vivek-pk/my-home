...
export default async function HomeownerDocumentsPage() {
  ...
  const allImages = [
    ...(project.images || []),
    ...project.timeline.flatMap((phase: any) => phase.updates?.flatMap((update: any) => update.images || []) || []),
  ]
    ...
    <HomeownerLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">View floor plans, photos, and project documentation</p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Official project blueprints and documentation</CardDescription>
          </CardHeader>
          <CardContent>
            {project.floorPlans && project.floorPlans.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {project.floorPlans.map((file: any, index: number) => (
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Progress photos and project images</CardDescription>
          </CardHeader>
          <CardContent>
            {allImages.length > 0 ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground">No project photos available yet</p>
              </div>
            )}
          </CardContent>
        </Card>
