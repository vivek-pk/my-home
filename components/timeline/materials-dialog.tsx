...
export function MaterialsDialog({ open, onOpenChange, projectId, phase, onSuccess }: MaterialsDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Update materials list for the "{phase.name}" phase</DialogDescription>
        </DialogHeader>
                  ...
                  <CardContent className="pt-4">
                    <div className="flex items-center justify-between">
                      <div className="grid grid-cols-4 gap-4 flex-1">
                        ...
                        <div>
                          <span className="text-sm">{material.cost ? `$${material.cost}` : "No cost"}</span>
                        </div>
                        <div>
                          <span className="text-sm text-muted-foreground">{material.supplier || "No supplier"}</span>
                        </div>
                      </div>
